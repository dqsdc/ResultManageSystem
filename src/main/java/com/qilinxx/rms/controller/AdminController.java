...
//        response.setContentType("application/OCTET-STREAM;charset=UTF-8");
    ...
    @ResponseBody
    public JSONObject ajaxMeetingEditForm(String key, HttpServletRequest request, Meeting meeting, String startTimeDate, String endTimeDate) throws IOException {
        JSONObject json = new JSONObject();
        //以下三种种错误
        startTimeDate += ":00";
        endTimeDate += ":00";
